...
#include "ttnn/operations/experimental/conv_transpose2d_polyphase/conv_transpose2d_polyphase_nanobind.hpp"
...
void py_module(nb::module_& mod) {
    ...
    ttnn::operations::experimental::conv_transpose2d_polyphase::detail::bind_experimental_conv_transpose2d_polyphase(
        mod);
