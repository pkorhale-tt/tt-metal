...
void kernel_main() {
    ...
    // Compact twiddles are stored in DRAM as one full tile page.
    // Only the first half_N floats are valid; the rest are zero padded by host.
    ...
    // Compact twiddles live in a normal tile-sized DRAM page because they
    // are fetched through noc_async_read_tile().
