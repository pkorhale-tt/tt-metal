    ...
    std::shared_ptr<MeshBuffer> output_buf)
{
    ...
    auto rk=CreateKernel(prog,"tt_metal/programming_examples/fft/kernel/fft_reader.cpp",cr,
        DataMovementConfig{.processor=DataMovementProcessor::RISCV_0,
                           .noc=NOC::RISCV_0_default,.compile_args=ct_rw});
    auto wk=CreateKernel(prog,"tt_metal/programming_examples/fft/kernel/fft_writer.cpp",cr,
        DataMovementConfig{.processor=DataMovementProcessor::RISCV_1,
                           .noc=NOC::RISCV_1_default,.compile_args=ct_rw});
    CreateKernel(prog,"tt_metal/programming_examples/fft/kernel/fft_compute.cpp",cr,
