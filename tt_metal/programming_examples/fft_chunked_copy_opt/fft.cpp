...
int main(int argc, char** argv) {
    ...
    createCB(program, core, CBIndex::c_8, 1, cb_total_size);
    createCB(program, core, CBIndex::c_9, 1, cb_total_size);
    // Data read from reader in DDR to compute core, real and imaginary
    createCB(program, core, CBIndex::c_20, 1, cb_total_size);
    createCB(program, core, CBIndex::c_21, 1, cb_total_size);
    // Twiddle read from reader in DDR to compute core
    createCB(program, core, CBIndex::c_22, 1, cb_total_size);
