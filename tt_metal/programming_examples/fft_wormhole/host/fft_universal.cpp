    ...
    bool      inverse)
{
    ...
    auto reader = CreateKernel(
        program,
        "tt_metal/programming_examples/fft_wormhole/kernels/fft_small_reader.cpp",
        core_range,
        DataMovementConfig{
    ...
    auto compute = CreateKernel(
        program,
        "tt_metal/programming_examples/fft_wormhole/kernels/fft_small_compute.cpp",
        core_range,
        ComputeConfig{
    ...
    auto writer = CreateKernel(
        program,
        "tt_metal/programming_examples/fft_wormhole/kernels/fft_small_writer.cpp",
        core_range,
        DataMovementConfig{
    ...
    bool      inverse)
{
    ...
    // CB0=input, CB1=scratch, CB2=twiddles, CB3=output
    ...
    auto reader = CreateKernel(
        program,
        "tt_metal/programming_examples/fft_wormhole/kernels/fft_medium_reader.cpp",
        core_range,
        DataMovementConfig{
            .processor = DataMovementProcessor::RISCV_0,
            .noc       = NOC::RISCV_0_default
    ...
    auto compute = CreateKernel(
        program,
        "tt_metal/programming_examples/fft_wormhole/kernels/fft_medium_compute.cpp",
        core_range,
        ComputeConfig{
            .math_fidelity    = MathFidelity::HiFi4,
            .fp32_dest_acc_en = true,
    ...
    auto writer = CreateKernel(
        program,
        "tt_metal/programming_examples/fft_wormhole/kernels/fft_medium_writer.cpp",
        core_range,
        DataMovementConfig{
            .processor = DataMovementProcessor::RISCV_1,
            .noc       = NOC::RISCV_1_default
    ...
    bool      inverse)
{
    ...
    for (uint32_t g = 0; g < active_groups; ++g) {
        ...
        auto reader = CreateKernel(
            program,
            "tt_metal/programming_examples/fft_wormhole/kernels/fft_large_reader1.cpp",
            cr,
            DataMovementConfig{
                .processor = DataMovementProcessor::RISCV_0,
                .noc       = NOC::RISCV_0_default
        ...
        auto compute = CreateKernel(
            program,
            "tt_metal/programming_examples/fft_wormhole/kernels/fft_large_compute.cpp",
            cr,
            ComputeConfig{
                .math_fidelity    = MathFidelity::HiFi4,
                .fp32_dest_acc_en = true,
        ...
        auto writer = CreateKernel(
            program,
            "tt_metal/programming_examples/fft_wormhole/kernels/fft_large_writer.cpp",
            cr,
            DataMovementConfig{
                .processor = DataMovementProcessor::RISCV_1,
                .noc       = NOC::RISCV_1_default
    ...
    bool         inverse = false)
{
    ...
    auto& cq = detail::GetCommandQueue(device);
    ...
    EnqueueWriteBuffer(cq, src_buf, data_host, false);
    EnqueueWriteBuffer(cq, tw_buf, twiddles.data(), false);
    ...
    EnqueueReadBuffer(cq, dst_buf, out_host, true);
}
